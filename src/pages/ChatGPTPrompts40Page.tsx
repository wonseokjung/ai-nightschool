...
const ChatGPTPrompts40Page: React.FC = () => {
...
과제: 6개월 내에 팀 성과를 20% 향상시킬 수 있는 구체적인 액션플랜을 세워주세요.
...
일과 삶의 균형을 고려한 시간 배분 전략`
  ...
  return (
    <div className="masterclass-container">
      ...
      {/* 카테고리별 프롬프트 섹션 */}
      <div style={{ padding: 'clamp(30px, 6vw, 60px) clamp(15px, 3vw, 20px)', background: '#0f172a' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            {categories.map((category) => (
              <div key={category.id} style={{
                ...
                <div
                  ...
                  style={{
                    padding: '25px',
                    background: activeCategory === category.id ? category.color : 'rgba(30, 41, 59, 0.5)',
                    color: '#f8fafc',
                    cursor: 'pointer',
                    display: 'flex',
